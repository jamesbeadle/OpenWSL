  ...
  actor Self {
        ...
        case (#Dapp){
          ...
          let dappsMinusBackend = Array.filter<Root.CanisterSummary>(
            ...
            func(dapp: Root.CanisterSummary){
              dapp.canister_id != ?Principal.fromText(NetworkEnvironmentVariables.OPENWSL_BACKEND_CANISTER_ID);
            }
          );
    ...
    system func postupgrade() {
      ...
      seasonManager.setStableDataHashes([
        { category = "clubs"; hash = "OPENWSL_1" },
        { category = "fixtures"; hash = "OPENWSL_1" },
        { category = "weekly_leaderboard"; hash = "OPENWSL_1" },
        { category = "monthly_leaderboards"; hash = "OPENWSL_1" },
        { category = "season_leaderboard"; hash = "OPENWSL_1" },
        { category = "players"; hash = "OPENWSL_1" },
        { category = "player_events"; hash = "OPENWSL_1" },
        { category = "countries"; hash = "OPENWSL_1" },
        { category = "system_state"; hash = "OPENWSL_1" },
        { category = "seasons"; hash = "OPENWSL_1" }
      ]);
  ...
  public shared ({ caller }) func notifyAppsOfSeasonComplete(seasonId: FootballTypes.SeasonId) : async Result.Result<(), T.Error> {
    ...
    public func transferFPLToNewBackendCanister() : async FPLLedger.TransferResult {
      ...
      return await ledger.icrc1_transfer({
        ...
        to = {owner = Principal.fromText(NetworkEnvironmentVariables.OPENWSL_BACKEND_CANISTER_ID); subaccount = null};
        amount = e8s - fpl_fee;
        fee = ?fpl_fee;
